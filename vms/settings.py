...
SECRET_KEY = 'django-insecure-v&qfhdh)70*%e95g$+bwb&pdatts_v4(dnwvb5)d@v38q%2jr8'
...
LOGGING = {
    ...
    'root': {
        'handlers': ['console', 'file'],  # Output to console and file
        'level': 'INFO',  # Minimum level to log (INFO or DEBUG for more details)
    },
}
